...
irr_mngt = IrrigationManagement(irrigation_method=4)

Rel=60
RedaCCx=74
CCx=92
potato = Crop('PotatoGDDAQTEST', planting_date='05/01',soil_fert_stress=1,
             RelativeBio=Rel/100,Ksccx_in=RedaCCx/CCx,fcdecline_in=1,
             sfertstress=0.72)

# Calibration run
model1 = AquaCropModel(sim_start_time=f'{1976}/05/01',
